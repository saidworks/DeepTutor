...
_BOOTSTRAP_PACKAGES: list[tuple[str, str]] = [
    ("yaml", "PyYAML>=6.0"),
]
...
# ===================================================================
# Web path helpers — spawn temp server, drain output, kill process
# ===================================================================
...
# ===================================================================
# Web tour path — install deps, start temp server, wait for browser config
# ===================================================================
...
def _run_web_tour() -> None:
    ...
    profile = select(
        ...
        [
            ...
            ("web-tutorbot", "web-tutorbot", "+ TutorBot engine"),
            ("web-matrix", "web-matrix", "+ Matrix channel"),
        ],
    )
...
# ===================================================================
# CLI tour path — full interactive configuration in the terminal
# ===================================================================
...
def run_tour() -> None:
    ...
    # Dual-mode entry: Web (browser config) vs CLI (terminal config)
    mode = select(
        "Choose tour mode",
        [
            ("web", "Web (browser-based)", "Open a local settings page in your browser"),
            ("cli", "CLI (terminal)", "Full interactive wizard in this terminal"),
        ],
    )
